                  ...
                  <div className="card__content flex flex-col relative text-white">
                    <h3 className={`card__title font-semibold text-2xl m-0 mb-2 ${textAutoHide ? 'text-clamp-1' : ''}`}>
                      {card.value !== undefined ? (
                        typeof card.value === 'string' 
                          ? card.value
                          : typeof card.value === 'number' && (card.label?.toLowerCase().includes('income') || card.label?.toLowerCase().includes('rent'))
                            ? card.value > 1000
                    ...
                    {card.trend !== undefined && (
                      <div className="mt-2 text-xs opacity-75">
                        {card.trend > 0 ? (
                          <span className="text-green-400">+{card.trend}% from last period</span>
                        ) : card.trend < 0 ? (
                          <span className="text-red-400">{card.trend}% from last period</span>
                        ) : (

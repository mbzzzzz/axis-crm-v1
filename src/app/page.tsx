      ...
      <div className="relative flex min-h-screen flex-col">
        ...
        <main className="relative z-10 container mx-auto flex flex-1 flex-col items-center justify-center px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-16 text-center">
          ...
          <section className="mt-8 sm:mt-12 md:mt-16 lg:mt-24 grid w-full max-w-5xl gap-3 sm:gap-4 md:gap-6 lg:gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 px-4">
            <Link href="/solutions/tenant-management" className="contents">
              <article className="flex flex-col items-center gap-2 sm:gap-3 md:gap-4 rounded-lg border border-white/20 bg-white/10 p-3 sm:p-4 md:p-6 shadow-lg backdrop-blur-md transition-transform hover:scale-105 cursor-pointer">
            ...
            <Link href="/solutions/invoicing" className="contents">
              <article className="flex flex-col items-center gap-2 sm:gap-3 md:gap-4 rounded-lg border border-white/20 bg-white/10 p-3 sm:p-4 md:p-6 shadow-lg backdrop-blur-md transition-transform hover:scale-105 cursor-pointer">
